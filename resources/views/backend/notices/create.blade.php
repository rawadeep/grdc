<x-layouts.backend>
    <x-backend.card>
        ...
        <form action="{{ route(prefixed_route('notices.store')) }}" method="post" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <x-backend.input.default name="short_description"
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="form-group">
                        ...
                        <x-backend.input.default type="date" name="published_at" value="{{ now()->format('Y-m-d') }}"
                            required="required" />
                    </div>
                </div>
            </div>
