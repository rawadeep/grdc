<x-layouts.backend>
    <x-backend.add-btn href="{{ route(prefixed_route('project-objectives.create')) }}" />
    <x-backend.card>
            ...
            <table class="table table-striped table-condensed">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <x-backend.edit-btn
                                route="{{ route(prefixed_route('project-objectives.edit'), $page->id) }}" />
                            <x-backend.delete-btn
                                action="{{ route(prefixed_route('project-objectives.destroy'), $page->id) }}" />
                        </td>
                        <td>{{ $page->title }}</td>
